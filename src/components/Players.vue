<template>
  <div class="wrapper-players">
    <div class="player-panel" :class="getClassNameWinner(0)">
    ...
    <div class="player-panel" :class="getClassNameWinner(1)">
...
export default {
  ...
  methods: {
    getNamePlayer(index) {
      ...
      if (this.isWinner && this.activePlayer === index) {
        defaultName = 'Winner!';
      }
      return defaultName;
    },
    getClassNameWinner(index) {
...
.player-panel.winner {
  background-image: url('https://i.pinimg.com/originals/41/e7/4b/41e74b0f91b7cb7df6b73e34ae8528a4.gif');
}
.player-name {
  font-size: 40px;
  text-align: center;
